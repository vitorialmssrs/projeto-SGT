...
public class FuncionalidadeFuncionario extends JFrame {
	...
	public FuncionalidadeFuncionario(Funcionario fun) {
		...
		panelOpcoes.setLayout(new MigLayout("", "[100][300][150]", "[50][100][50][50][150][150][150][150][150][150][150]"));
		...
		panelOpcoes.add(btnAtualizarEspaco, "cell 1 6,grow");
		...
		panelOpcoes.add(btnNewButton_1, "flowy,cell 1 7,grow");
		...
		panelOpcoes.add(btnNewButton, "cell 1 8,grow");
		...
		panelOpcoes.add(btnPerfil, "cell 1 9,grow");
