...
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Brinquedoteca', '2023-07-09', '2023-12-28', '19:09', '18:13', 30);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Quiosque', '2023-09-06', '2023-08-02', '9:59', '9:34', 5);
...
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Quadra de vôlei', '2023-11-28', '2023-12-03', '16:00', '22:56', 8);
...
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Academia', '2023-03-07', '2023-04-16', '11:56', '11:34', 6);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Salão de festa', '2023-04-24', '2023-05-04', '9:42', '0:52', 15);
...
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Brinquedoteca', '2023-07-14', '2023-12-11', '5:48', '16:47', 6);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Psicina', '2023-06-10', '2023-06-27', '9:03', '4:41', 100);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Sala de jogos', '2023-01-13', '2023-10-15', '4:48', '7:09', 80);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Quiosque', '2023-09-09', '2023-01-28', '13:37', '5:33', 20);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'SPA', '2023-08-31', '2023-09-19', '21:43', '11:04', 5);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Academia', '2023-10-27', '2023-08-26', '14:15', '17:17', 4);
insert into espacos_hotel (nome_espaco, dia_semana_abertura, dia_semana_fechamento, horario_abertura, horario_fechamento, capacidade) values ( 'Quadra de futebol', '2023-07-25', '2023-07-24', '22:27', '9:05', 4);

-- Funcionarios
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (80279558948,'gbydaway0', 's5lRGZg','Winni Fust','2002-11-09' ,'(55) 30545-12246', '12345678','181', 21);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (51798654383,'gmacpaike1', 'a3aAJ2p','Addy Beeby','2003-12-06','(20) 56746-78607', '23456789','30', 22);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (36600142945,'lormond2', 'g1AWE6R','Nate Dary','2003-07-17' ,'(41) 30913-40051', '34567890','32', 23);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (59820786099,'dschruyers3', 'g3SLNdt','Lorinda Wyllie','2003-05-14','(98) 18282-95072', '45678901','48', 24);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (68293762115,'fswansborough4', 'l3KFzgf','Luciana Berthomier','2003-07-17' ,'(36) 21570-09441', '56789012','44', 25);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (98784461294,'asimmank5', 'h8TuF4E','Martguerita Klimkov','2002-11-09','(50) 92911-67508', '67890123','207', 26);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (22476559827,'taviss6', 'c9EvM9a','Clement Tatershall', '2003-02-17' ,'(72) 43169-23646', '78901234','27', 27);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (11840432748,'sklossmann7', 'u9j3j52','Fern Blaw','2003-02-04','(48) 40285-23713', '89012345','282',  28);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (34484601536,'jhutcheon8', 's9O2sj7','Thorstein Railton','2003-03-04','(35) 29851-67897', '90123456','13', 29);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (34788143156,'imonger9', 'k3b343w','Kynthia Fortman',    '2003-02-13','(67) 62556-88487', '01234567','170', 30);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (62011924574,'cedmondsona', 'l0eMDE1','Libbi Gallahue','2003-08-31','(87) 60131-27438', '13579246','252', 31);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (16842105315,'gcrickettb', 'k0RKzG0','Lenette Sallier','2003-01-06','(91) 68715-51266', '24681357','227', 32);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (18645205830,'thayhurstc', 'w3VeaHh','Charlton Corrison','2003-07-06','(32) 44598-44507', '35792468','115', 33);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (78290779822,'tnasebyd', 'k8ZqBd0','Nickie Manderson','2003-01-14' ,'(47) 60111-64991', '46813579','218', 34);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (14050244497,'mbeazeye', 'u5Na6ul','Lesly Whiterod','2003-02-26','(50) 30329-22362', '57924680','49', 35);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (48452886351,'mglaisnerf', 's90Ii9F','Augustine Levison','2002-11-15','(74) 33643-42140', '68035791', '812', 36);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (54858538614,'nlafflingg', 'f76jHyA','Kally Lintin','2003-05-26','(22) 66238-29756', '80257913','162', 37);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (91615917098,'gconrathh', 'f70xt6l','Gil Daykin','2002-11-01','(36) 45036-43148', '91368024','56', 38);
insert into funcionarios (num_identificacao, login, senha, nome_completo, data_nascimento, telefone , cep, num_casa, id_funcionario) values (21602762177,'mferdinandi', 'g9Ocf7K','Benny Gabbitis','2003-07-10','(50) 62540-51373', '79146802','59', 39);
